export const BASE_URL = 'https://orchid-be.azurewebsites.net/api/v1/'
...
export const GET_USER_BY_ID_URL = 'users/' // + id
export const PUT_UPDATE_USER_URL = 'users/' // + id
...
export const POST_PRODUCT_URL = 'products'
export const POST_PRODUCT_COUNT_URL = 'products/count'
